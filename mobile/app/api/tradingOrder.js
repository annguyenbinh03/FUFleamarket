...
export const getMyTradingOrderAPI = (token, tab, sortBy) => {
  ...
  return axiosClient.get(
    `${END_POINT.GET_MY_TRADING_ORDER}?tab=${tab}&sortBy=${sortBy}`,
    config
  );
};
...
export const getMyTradingOrderRequestAPI = (token, tab, sortBy) => {
  ...
  return axiosClient.get(
    `${END_POINT.GET_MY_TRADING_ORDER_REQUEST}?tab=${tab}&sortBy=${sortBy}`,
    config
  );
};
...
export const user2AcceptRequest = (token, orderId) => {
  ...
  return axiosClient.post(
    `${END_POINT.USER2_ACCEPT_REQUEST}/${orderId}`,
    null,
    config
  );
};
export const user2RejectRequest = (token, orderId) => {
  ...
  return axiosClient.post(
    `${END_POINT.USER2_REJECT_REQUEST}/${orderId}`,
    null,
    config
  );
};
...
export const user1CompleteTradingRequest = (token, orderId) => {
  ...
  return axiosClient.post(
    `${END_POINT.USER1_COMPLETE_REQUEST}/${orderId}`,
    null,
    config
  );
};
export const user1RejectTradingRequest = (token, orderId) => {
  ...
  return axiosClient.post(
    `${END_POINT.USER1_REJECT_REQUEST}/${orderId}`,
    null,
    config
  );
};
