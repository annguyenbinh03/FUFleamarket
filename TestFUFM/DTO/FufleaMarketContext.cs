...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Address__26A111AD54BE7A55");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__23CAF1D879A3F072");
        });

        modelBuilder.Entity<Feedback>(entity =>
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__2613FD2467642E0F");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__Message__4808B9936FCCB7B8");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Order__0809335D5818551C");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__2D10D16A23B9C444");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__99EB696E743E1C4E");
        });

        modelBuilder.Entity<PromotionOrder>(entity =>
        {
            entity.HasKey(e => e.PromoOrderId).HasName("PK__Promotio__BCD805E574DDA04A");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__CB9A1CFF79C3876E");
